...
class _CreditCardWidgetState extends State<CreditCardWidget> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (kIsWeb) {
      children.add(widget.showBackView
          ? buildBackContainer(width, height, context, orientation)
          : buildFrontContainer(width, height, context, orientation));
    } else {
      children.add(AnimationCard(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text(
                          widget.expiryDate.isEmpty || widget.expiryDate == null ? 'MM/YY' : widget.expiryDate,
                          style: widget.textStyle ?? defaultTextStyle,
                        ),
                      ],
                    ),
