...
class ParkingStartResponse {
  Response _response;

  ParkingStartResponse({Response response}) {
  ...
  ParkingStartResponse.withError(String errorValue)
      : _response = Response(),
        _error = errorValue;
  String _error;
  ParkingStartResponse.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({String stopDateTime}) {
    this._stopDateTime = stopDateTime;
  }

  String get stopDateTime => _stopDateTime;

  set stopDateTime(String value) {
    _stopDateTime = value;
  }

  Data.fromJson(Map<String, dynamic> json) {
    _stopDateTime = parseCDATA(json['StopDateTime']);
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['StopDateTime'] = this._stopDateTime;
    return data;
  }
}
